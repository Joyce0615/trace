...
contextBridge.exposeInMainWorld("trace", {
  ...
  signingIdentity: (request) => ipcRenderer.invoke("signing:identity", request),
  trustKey: (request) => ipcRenderer.invoke("signing:trust", request),
  ...
  importArchive: (request) => ipcRenderer.invoke("archive:import", request),
  ...
  forgetExperiments: (request) => ipcRenderer.invoke("experiment:forget", request),
