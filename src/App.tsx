...
import { emptyArchitectureState, emptyChainState, emptyDiagnosisState, emptyEvaluationState, emptyEvidenceState, emptyHistoryState, emptyLocalizationState, emptyReviewState, emptyScheduleState, emptyTraceState, type ArchitectureState, type ChainState, type DiagnosisState, type EvaluationState, type EvidenceState, type HistoryState, type LocalizationState, type ReviewState, type ScheduleState, type TraceState } from "./exercise-state";
